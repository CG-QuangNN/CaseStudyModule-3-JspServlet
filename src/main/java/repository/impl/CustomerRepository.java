...
public class CustomerRepository implements ICustomerRepository {
    private static final String SELECT_ALL = "select customer_id, customer_code, customer_type_id, customer_name, customer_birthday, customer_gender, customer_id_card, customer_phone, customer_email, customer_address from customer;";
    private static final String SELECT_ALL_LIST_DTO = "select c.customer_code, ct.customer_type_name, c.customer_name, c.customer_birthday, c.customer_gender, c.customer_id_card, c.customer_phone, c.customer_email, c.customer_address from customer c inner join customer_type ct on c.customer_type_id = ct.customer_type_id;";
    ...
    public List<CustomerListDto> findAllListDto() {
        ...
        try (Connection connection = MySQLUtil.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_ALL_LIST_DTO)) {
